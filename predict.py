...
def possible_urls(time, hd):
    ...
    if hd:
        url_format = 'https://nomads.ncep.noaa.gov/dods/gfs_0p50/gfs%i%02i%02i/gfs_0p50_%02iz'
    else:
        url_format = 'https://nomads.ncep.noaa.gov/dods/gfs_1p00/gfs%i%02i%02i/gfs_1p00_%02iz'
